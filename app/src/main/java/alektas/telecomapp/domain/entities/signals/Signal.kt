...
interface Signal {
    ...
    /**
     * Возвращает все моменты времени, на которых измерялись значения сигнала.
     */
    fun getTimes(): DoubleArray

    /**
     * Возвращает моменты времени от <code>from</code> до <code>to</code> на временной шкале,
     * на которых измерялись значения сигнала.
     *
     * @param from от какого момента времени брать значения (включительно), в секундах
     * @param to до какого момента времени брать значения (не включительно), в секундах
     */
    fun getTimes(from: Double, to: Double): DoubleArray
